...
resource "azurerm_virtual_network_peering" "peering-management-sap" {
  name                         = substr("${data.azurerm_virtual_network.vnet-mgmt.resource_group_name}_${data.azurerm_virtual_network.vnet-mgmt.name}-${local.vnet_sap_exists ? data.azurerm_virtual_network.vnet-sap[0].resource_group_name : azurerm_virtual_network.vnet-sap[0].resource_group_name}_${local.vnet_sap_exists ? data.azurerm_virtual_network.vnet-sap[0].name : azurerm_virtual_network.vnet-sap[0].name}", 0, 80)
  resource_group_name          = data.azurerm_virtual_network.vnet-mgmt.resource_group_name
  virtual_network_name         = data.azurerm_virtual_network.vnet-mgmt.name
...
resource "azurerm_virtual_network_peering" "peering-sap-management" {
  name                         = substr("${local.vnet_sap_exists ? data.azurerm_virtual_network.vnet-sap[0].resource_group_name : azurerm_virtual_network.vnet-sap[0].resource_group_name}_${local.vnet_sap_exists ? data.azurerm_virtual_network.vnet-sap[0].name : azurerm_virtual_network.vnet-sap[0].name}-${data.azurerm_virtual_network.vnet-mgmt.resource_group_name}_${data.azurerm_virtual_network.vnet-mgmt.name}", 0, 80)
  ...
  remote_virtual_network_id    = data.azurerm_virtual_network.vnet-mgmt.id
  allow_virtual_network_access = true
